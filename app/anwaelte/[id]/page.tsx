  ...
  if (!lawyer) {
    return (
      <div className="min-h-screen bg-[#f0f2f5] flex flex-col items-center justify-center gap-4">
        ...
        <a href="/anwaelte" className="text-[#0F2444] underline text-sm">Zurück zum Verzeichnis</a>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#f0f2f5] font-sans">
      ...
      <nav className="bg-[#0F2444] px-8 py-4 flex items-center gap-5 sticky top-0 z-20 shadow-lg">
        ...
        <a href="/anwaelte" className="flex items-center gap-2 text-white/60 hover:text-white text-sm font-medium transition">
